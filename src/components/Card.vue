<template>
  <article :class='{
      card: true,
      visible: visible,
      isPlayer: $props.isPlayerCard,
      selected: $props.selected,
      dying: $props.dying
    }' @click='$emit("selected", cardData.id)'>
    ...
    <transition name='fade' mode='out-in'>
      <svg v-if='$props.dying' class='skull' xmlns="http://www.w3.org/2000/svg" viewbox='0 0 510 490'>
...
.skull {
  ...
  width: 510px;
  height: 490px;
  filter: drop-shadow(3px 5px 20px #00000091) brightness(85%);
}
...
.card {
  ...
  transition: transform 0.2s, background-color 0.2s, width 0.2s 0.3s,
    margin 0.2s 0.3s;
  cursor: pointer;
